...
ARCHITECTURES: dict[str, dict] = {
    "yolov8": {"label": "YOLOv8", "sizes": ["n", "s", "m"], "weights": "yolov8{size}.pt"},
    "yolo11": {"label": "YOLO11", "sizes": ["n", "s", "m"], "weights": "yolo11{size}.pt"},
    "rtdetr": {"label": "RT-DETR", "sizes": ["l"], "weights": "rtdetr-l.pt"},
}
